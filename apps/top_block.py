...
# Title: Top Block
# Generated: Tue Oct 24 19:16:33 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, 6817)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_gr_complex*8192)
        ...
        self.connect((self.dvbt_rx_sync_cc_0, 0), (self.blocks_null_sink_0, 0))    
        self.connect((self.dvbt_rx_sync_cc_0, 1), (self.blocks_vector_to_stream_0, 0))    
